...
const AuthModal = ({ isSuccess, onClose, onSubmit }: AuthModalProps) => {
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black/20 z-50">
                ...
                <div className="flex flex-col justify-center items-center relative py-5 gap-4 rounded-lg shadow-lg bg-[#FAFAFA] lg:w-2/5 md:w-3/5 w-4/5">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-2">
                        ...
                        <p className="lg:text-base text-sm font-light text-center md:mx-10 mx-5"> 
                            Please enter credentials to confirm your identity 
                        </p>
                    </div>

                    {/* Form Section */}
                    <form className="md:w-3/5 w-4/5" onSubmit={handleSubmit}>
                        ...
                        <div className="lg:mb-12 md:mb-8 mb-5">
                            ...
                            {!isSuccess && 
                                <p className="mt-3 text-[#BA4C3D] md:text-sm text-xs"> Incorrect credentials. Please try again. </p>
                            }
                        </div>

                        <div className="flex gap-5 justify-end">
                            <button type="button" onClick={onClose} className="text-white bg-[#BA4C3D] hover:hover:bg-[#B22222] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto md:px-8 px-3 lg:py-3 py-2 text-center"> Close </button>
                            <button type="submit" className="text-white bg-[#849F5D] hover:hover:bg-[#758c54] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto md:px-8 lg:py-3 px-3 py-2 text-center"> Send </button>
                        </div>
                    </form>
                </div>
            </div>
